...
<body class="bg-light">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center">
        <div class="card mb-3">
            <div class="card-header text-bg-warning h3">ฟอร์มการแก้ไขสมาชิก</div>
            <div class="card-body">
                <?php
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id=" . $result->id); ?>" method="post" class="row">
                    ...
                    <div class="col-12 mb-3">
                        <label for="studentEmail" class="form-label">อีเมล</label>
                        <?php if ($error["email"]) { ?>
                    ...
                    <div class="col-6 mb-3">
                        <label for="studentNameEng" class="form-label">ชื่อ (Eng.)</label>
                    ...
                    <div class="col-6 mb-3">
                        <label for="studentSurnameEng" class="form-label">นามสกุล (Eng.)</label>
                    ...
                    <div class="col-12 mb-3">
                        <label for="studentMajor" class="form-label">รหัสสาขาเอก</label>
                    ...
                    <button type="submit" class="col-1 btn btn-outline-warning ms-3">อัพเดต</button>
                    <a href="./index.php" class="col-1 btn btn-outline-danger ms-3">กลับ</a>
                </form>
                <?php } } ?>
            </div>
        </div>
